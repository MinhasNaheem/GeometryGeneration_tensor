...
filename = 'tracking_tool_90,130,0.csv'
...
minimum = 40
increment = 4
marker0 = np.vstack((fid1[0],fid2[0],fid3[0],fid4[0],fid5[0]))
...
for index in range(len(tre)):
    fids = np.vstack((fid1[index],fid2[index],fid3[index],fid4[index],fid5[index]))
